...
const data = [
    ...
    },
    {
        id: 4,
        title: "GOLD",
        desc: "Fifteen Services Per Month",
        value: 179.99,
        headerColor: '#C5AB30',
        bodyColor: '#CFB53B',
        fontColor: '#D6BF53'
    },
    {
        id: 5,
        title: "PLATINUM",
        desc: "Unlimited Services Per Month",
        value: 199.99,
        headerColor: '#2A305A',
        bodyColor: '#373D65',
        fontColor: '#4F5578'
...
const PlansAthletes = ({ navigation }) => {
    const Api = useApi()
            ...
            <ScrollView contentContainerStyle={{ justifyContent: "space-around" }} showsVerticalScrollIndicator={false}>
                <Box style={styles.header} bg={bodyColor}>
                    <HStack display="flex" justifyContent="space-between" alignItems="center" px={5}>
                        <Stack>
                            <Button borderRadius={15} size="xs" variant="ghost" h={30} w={30} bg={headerColor} onPress={() => navigation.navigate("AthletesDetailsScreen")} color={COLOR.white} space={1}>
                ...
                <VStack bg={headerColor} h={(Dimensions.get("window").height - 90)} alignItems="center" justifyContent="space-around" >
                    <Text fontSize="sm" color={COLOR.white}>ATHLETE PLANS</Text>
                    ...
                    <VStack justifyContent="center" alignItems="center">
                        {
                            index === 1 ?
                                <>
                                    ...
                                    <Text fontSize="sm" color={COLOR.white}>(Only Two Leads Per Month)</Text>
                                </>
                                :
                    ...
                    <VStack>
                        <Button borderRadius={20} h="30px" bg={COLOR.white} w={250} onPress={() => navigation.navigate("PaymentsAthletesScreen")}>
